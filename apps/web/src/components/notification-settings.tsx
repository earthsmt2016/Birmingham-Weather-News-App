...
export function NotificationSettings() {
  ...
  const getEndpoint = useCallback(async (): Promise<string | null> => {
    try {
      ...
      reportClientError("Failed to read push subscription endpoint", error);
    }
    return null;
  }, []);
  ...
  const loadPrefs = useCallback(async () => {
    ...
    try {
      ...
      reportClientError("Failed to load notification preferences", error);
    }
  }, [getEndpoint]);
  ...
  const checkSubscription = useCallback(async () => {
    ...
    try {
      ...
      reportClientError("Failed to check notification subscription", error);
      setStatus("unsubscribed");
    }
  }, []);
