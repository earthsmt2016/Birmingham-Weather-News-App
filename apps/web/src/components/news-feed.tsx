import type { NewsArticle, SavedArticle } from "@workspace/shared-api-zod";
...
async function shareArticle(article: NewsArticle) {
  if (navigator.share) {
    try {
      ...
      reportClientError("Native article share failed", error);
    }
  }
  try {
    await navigator.clipboard.writeText(article.link);
  } catch (error) {
    reportClientError("Clipboard article share fallback failed", error);
  }
}
